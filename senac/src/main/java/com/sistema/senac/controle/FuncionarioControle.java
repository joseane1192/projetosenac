...
public class FuncionarioControle {
    ...
    public ModelAndView editar(@PathVariable("id") Long id) {
    	Optional<Funcionario> funcionario = funcionarioRepositorio.findById(id);  //busca funcionario por id e armazenar
    	return cadastrar(funcionario.get());          //chama função cadastro
    }
